...
public class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_VEHICLE) {
            ...
            Log.d(TAG, "OnCreate AD View");

            View adViewParent = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.banner_vh, parent, false);

            PubMaticViewHolder adViewHolder = new PubMaticViewHolder((RelativeLayout) adViewParent);
    ...
    private class PubMaticViewHolder extends RecyclerView.ViewHolder {
        ...
        public PubMaticViewHolder(RelativeLayout adViewParent) {
            super(adViewParent);
            parent = adViewParent;
        }
        ...
        private void bind(PMBannerAdView adView) {
            ...
            RelativeLayout adViewParent = (RelativeLayout) adView.getParent();
